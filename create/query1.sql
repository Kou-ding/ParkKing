...
update 
    Public_Parking_Spot
set
    photograph = 'photograph.blob',
    time_when_marked_vacant = '2024-12-22 13:11:00',
    vacancy_status = 1
where 
    spot_location = "40.600658,22.956807";
...
-- Purpose: Query to get all the vacant public parking spots nearby.
select 
    spot_location, 
...
where 
    ...
    -- understanding the x and y coordinates from the varchar
    and
    vacancy_status = 1;